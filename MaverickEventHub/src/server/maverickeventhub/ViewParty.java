...
public class ViewParty extends Activity {
	int i=0;
    String username = "";
    int size=0;
	public void onCreate(Bundle savedInstanceState) {
		...
		Button button_help = (Button) findViewById(R.id.btn_view_party_help);
		Button button_close = (Button) findViewById(R.id.btn_view_party_close);
		Button button_next = (Button) findViewById(R.id.btn_view_party_next);
		Button button_previous = (Button) findViewById(R.id.btn_view_party_previous);
		TextView textview_party = (TextView) findViewById(R.id.tv_view_party);
		TextView textview_organizer = (TextView) findViewById(R.id.tv_party_organiser);
		TextView textview_organizer1 = (TextView) findViewById(R.id.tv_party_organiser1);
		TextView textview_name = (TextView) findViewById(R.id.tv_party_name);
		TextView textview_name1 = (TextView) findViewById(R.id.tv_party_name1);
		TextView textview_type = (TextView) findViewById(R.id.tv_party_type);
		TextView textview_type1 = (TextView) findViewById(R.id.tv_party_type1);
		TextView textview_date = (TextView) findViewById(R.id.tv_party_date);
		TextView textview_date1 = (TextView) findViewById(R.id.tv_party_date1);
		TextView textview_location = (TextView) findViewById(R.id.tv_party_location);
		TextView textview_location1 = (TextView) findViewById(R.id.tv_party_location1);
		TextView textview_fee = (TextView) findViewById(R.id.tv_party_fee);
		TextView textview_fee1 = (TextView) findViewById(R.id.tv_party_fee1);
		TextView textview_description = (TextView) findViewById(R.id.tv_party_description);
		TextView textview_description1 = (TextView) findViewById(R.id.tv_party_description1);
		TextView textview_extra = (TextView) findViewById(R.id.tv_party_extra);
		TextView textview_extra1 = (TextView) findViewById(R.id.tv_party_extra1);
		...
		button_help.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            	ViewParty.this.runOnUiThread(new Runnable() {
    	            public void run() {
    	                AlertDialog.Builder builder = new AlertDialog.Builder(ViewParty.this,R.style.AlertDialogTheme);
            ...
            public void onClick(View v) {
            	if(i>=size-1)
            	{
            		runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(ViewParty.this,"No more records.", Toast.LENGTH_SHORT).show();
                        }
                    });
            	}
            	else
		...
		button_previous.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {            	
            	if(i<=0)
            	{
            		runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(ViewParty.this,"Already at first record.", Toast.LENGTH_SHORT).show();
                        }
                    });
            	}
            	else
	...
	HttpPost httppost = new HttpPost("http://omega.uta.edu/~jxm6478/viewparty.php"); //YOUR PHP SCRIPT ADDRESS
