...
public class ViewFeast extends Activity {
	int i=0;
    String username = "";
    int size=0;
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.viewfeast);
		Bundle extras = getIntent().getExtras();
		if (extras != null) {
		    username = extras.getString("username");
		}
		
		Button button_help = (Button) findViewById(R.id.btn_view_feast_help);
		Button button_close = (Button) findViewById(R.id.btn_view_feast_close);
		Button button_next = (Button) findViewById(R.id.btn_view_feast_next);
		Button button_previous = (Button) findViewById(R.id.btn_view_feast_previous);
		TextView textview_feast = (TextView) findViewById(R.id.tv_view_feast);
		TextView textview_organizer = (TextView) findViewById(R.id.tv_feast_organiser);
		TextView textview_organizer1 = (TextView) findViewById(R.id.tv_feast_organiser1);
		TextView textview_name = (TextView) findViewById(R.id.tv_feast_name);
		TextView textview_name1 = (TextView) findViewById(R.id.tv_feast_name1);
		TextView textview_type = (TextView) findViewById(R.id.tv_feast_type);
		TextView textview_type1 = (TextView) findViewById(R.id.tv_feast_type1);
		TextView textview_date = (TextView) findViewById(R.id.tv_feast_date);
		TextView textview_date1 = (TextView) findViewById(R.id.tv_feast_date1);
		TextView textview_location = (TextView) findViewById(R.id.tv_feast_location);
		TextView textview_location1 = (TextView) findViewById(R.id.tv_feast_location1);
		TextView textview_fee = (TextView) findViewById(R.id.tv_feast_fee);
		TextView textview_fee1 = (TextView) findViewById(R.id.tv_feast_fee1);
		TextView textview_description = (TextView) findViewById(R.id.tv_feast_description);
		TextView textview_description1 = (TextView) findViewById(R.id.tv_feast_description1);
		TextView textview_extra = (TextView) findViewById(R.id.tv_feast_extra);
		TextView textview_extra1 = (TextView) findViewById(R.id.tv_feast_extra1);
		...
		button_help.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            	ViewFeast.this.runOnUiThread(new Runnable() {
    	            public void run() {
    	                AlertDialog.Builder builder = new AlertDialog.Builder(ViewFeast.this,R.style.AlertDialogTheme);
            ...
            public void onClick(View v) {
            	if(i>=size-1)
            	{
            		runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(ViewFeast.this,"Sorry, No more events.", Toast.LENGTH_SHORT).show();
                        }
                    });
            	}
            	else
		...
		button_previous.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {            	
            	if(i<=0)
            	{
            		runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(ViewFeast.this,"Already at first event.", Toast.LENGTH_SHORT).show();
                        }
                    });
            	}
            	else
	...
	HttpPost httppost = new HttpPost("http://omega.uta.edu/~jxm6478/viewfeast.php"); //YOUR PHP SCRIPT ADDRESS
