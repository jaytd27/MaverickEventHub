...
public class EditContest extends Activity {
	int i=0;
    String username = "";
    int size=0;
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.editcontest);
		Bundle extras = getIntent().getExtras();
		if (extras != null) {
		    username = extras.getString("username");
		}
		
		Button button_help = (Button) findViewById(R.id.btn_edit_contest_help);
		Button button_close = (Button) findViewById(R.id.btn_edit_contest_close);
		Button button_next = (Button) findViewById(R.id.btn_edit_contest_next);
		Button button_previous = (Button) findViewById(R.id.btn_edit_contest_previous);
		Button button_update = (Button) findViewById(R.id.btn_contest_update);
		TextView textview_contest = (TextView) findViewById(R.id.tv_edit_contest);
		EditText edittext_id = (EditText) findViewById(R.id.eT_contest_id);
		TextView textview_id1 = (TextView) findViewById(R.id.tv_edit_contest_id1);
		EditText edittext_name = (EditText) findViewById(R.id.eT_contest_name);
		TextView textview_name1 = (TextView) findViewById(R.id.tv_edit_contest_name1);
		EditText edittext_type = (EditText) findViewById(R.id.eT_contest_type);
		TextView textview_type1 = (TextView) findViewById(R.id.tv_edit_contest_type1);
		EditText edittext_date = (EditText) findViewById(R.id.eT_contest_date);
		TextView textview_date1 = (TextView) findViewById(R.id.tv_edit_contest_date1);
		EditText edittext_prize = (EditText) findViewById(R.id.eT_contest_prize);
		TextView textview_prize1 = (TextView) findViewById(R.id.tv_edit_contest_prize1);
		EditText edittext_location = (EditText) findViewById(R.id.eT_contest_location);
		TextView textview_location1 = (TextView) findViewById(R.id.tv_edit_contest_location1);
		EditText edittext_fee = (EditText) findViewById(R.id.eT_contest_fee);
		TextView textview_fee1 = (TextView) findViewById(R.id.tv_edit_contest_fee1);
		EditText edittext_description = (EditText) findViewById(R.id.eT_contest_description);
		TextView textview_description1 = (TextView) findViewById(R.id.tv_edit_contest_description1);
		EditText edittext_extra = (EditText) findViewById(R.id.eT_contest_extra);
		TextView textview_extra1 = (TextView) findViewById(R.id.tv_edit_contest_extra1);
		...
		button_help.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
            	EditContest.this.runOnUiThread(new Runnable() {
    	            public void run() {
    	                AlertDialog.Builder builder = new AlertDialog.Builder(EditContest.this,R.style.AlertDialogTheme);
            ...
            public void onClick(View v) {
            	if(i>=size-1)
            	{
            		runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(EditContest.this,"Sorry, No more events.", Toast.LENGTH_SHORT).show();
                        }
                    });
            	}
            	else
		...
		button_previous.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {            	
            	if(i<=0)
            	{
            		runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(EditContest.this,"Already at first event.", Toast.LENGTH_SHORT).show();
                        }
                    });
            	}
            	else
	...
	HttpPost httppost = new HttpPost("http://omega.uta.edu/~jxm6478/editcontest.php"); //YOUR PHP SCRIPT ADDRESS
